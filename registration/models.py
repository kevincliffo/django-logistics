...
class Delivery(models.Model):
    ...
    State_ID = models.ForeignKey('registration.State', verbose_name=u'Хот/Аймаг', on_delete=models.DO_NOTHING)
    SubState_ID = models.ForeignKey('registration.SubState', verbose_name=u'Дүүрэг/Сум', related_name='from_substate',  on_delete=models.DO_NOTHING)
    ...
    To_State_ID = models.ForeignKey('registration.State', verbose_name=u'Хот/Аймаг', related_name='to_state',  on_delete=models.DO_NOTHING)
    To_SubState_ID = models.ForeignKey('registration.SubState', verbose_name=u'Дүүрэг/Сум', related_name='to_substate',  on_delete=models.DO_NOTHING)
    ...
    Status_ID = models.ForeignKey('registration.Status', verbose_name=u'Төлөв',  on_delete=models.DO_NOTHING)
    ...
    User = models.ForeignKey(User, editable=True, blank=True, null=True, limit_choices_to={'groups__name': u"Хэрэглэгч"}, verbose_name=u'Хэрэглэгч',  on_delete=models.DO_NOTHING)
...
class Shipment(models.Model):
    ...
    Type_ID = models.ForeignKey(Type, verbose_name=u'Ачааны төрөл',  on_delete=models.DO_NOTHING)
    ...
    Delivery_ID = models.ForeignKey(Delivery, verbose_name=u'Хүргэлтийн дугаар',  on_delete=models.DO_NOTHING)
...
class SubState(models.Model):
    ...
    State_ID = models.ForeignKey(State, verbose_name=u'Хот/Аймаг',  on_delete=models.DO_NOTHING)
